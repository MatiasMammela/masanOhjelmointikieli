...
// Move / check expected /return expected
token_t *expect_token();
token_t *expect_assert(const char c);
token_t *expect_type();
token_t *expect_assert_token_type(token_type_t t);
token_t *expect_operation();

// Move / check expected / return current
token_t *accept_token();
token_t *accept_assert(const char c);
token_t *accept_type();
token_t *accept_assert_token_type(token_type_t t);
